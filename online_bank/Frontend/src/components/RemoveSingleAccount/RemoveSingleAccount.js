...
class RemoveSingleAccount extends React.Component {
    ...
    onSubmit = (e) => {
        ...
        if (this.props.myDetail.type !== "credit" && parseFloat(this.props.myDetail.balance) < 0) {
        ...
        axios.delete('api/accounts/close/' + this.props.myDetail.account_number,
            { headers: req_headers }
        )
            .then(response => {
    ...
    renderAccount() {
        ...
        if (this.props.myDetail.account_number !== " ") {
            return this.props.myDetail.account.map(account => {
                return (
                    <ExpansionPanelDetails onClick={(e) => {
                        this.selectAccountOne(e);
                        this.setState({
    ...
    render() {
        ...
        // console.log(this.state.currentAccount);
        // console.log(this.state.currentBalance);
        console.log("FROM REMOVE SINGLE ACCOUNT");
        console.log(this.props.myDetail.account_number);
        return (
            <div style={getModalStyle()} className={classes.paper}>
                <form noValidate onSubmit={this.onSubmit}>
                    ...
                    <h1 className="h3 mb-3 font-weight-normal"><strong>{this.props.myDetail.account_number}</strong></h1>
                    <hr />
                    <button
                        type="submit"
