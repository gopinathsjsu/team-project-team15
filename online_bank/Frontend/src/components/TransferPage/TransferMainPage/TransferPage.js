...
import cards from '../../../images/moneytransfer.jpeg';
                ...
                <Container>
                    ...
                    <div className={classes.root}>
                            <Paper className={classes.innerPaper} style={{position: 'flex'}}>
                                <br/>
                                <div> <img src={cards}
               alt="card" style={{position: 'flex'}} height="100px"/></div>
                                <br/>
                                <Typography variant="h4" color = "Navy"><strong>Make a Transfer</strong></Typography>
