...
class Refund extends React.Component{
    ...
    render() {
        ...
        this.state.selectTo = this.props.myDetail.account_number;
        console.log(this.state.selectTo);
        console.log(this.state.transferAmount);
        console.log("REFUNDD"+this.props.myDetail.account_number);
            ...
            <div>
                ...
                <Container>
                    ...
                    <Paper className={classes.innerPaper2} style={{position: 'flex'}}>
                        <Typography variant="h4" color = "Navy"><strong>Refund</strong></Typography>
                        <hr/>
                        <Typography variant="h6" color = "Navy"><strong>Admin Account</strong></Typography>
                        <br/>
                        ...
                        <input
                            ...
                            name="accountNumber"
                            maxLength={"10"}
                            placeholder={this.props.myDetail.account_number}
                        ...
                        <div>
                            ...
                            <div style={{float: 'right', width:'10%', marginRight: '280px'}}>
                                ...
                                <input
                                    style={{float: 'left', width:'150%', marginLeft: '200px'}}
                                    type="number"
...
export default connect(mapStateToProps)(withStyles(styles)(Refund));
