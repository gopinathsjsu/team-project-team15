...
import cards from '../../images/paybill.jpeg';
...
class BillPay extends React.Component{
    ...
    renderAutoPayState() {
           ...
           } else {return ( <Typography variant="h8" color= 'Navy'>
        ...
        if (index === null) {
            return (
                ...
                <Container>
                    ...
                    <Typography variant="h4" color= 'Navy'><strong>You Currently Don't Have a Credit Card Account</strong></Typography>
                    </div>
                </Container>
                </div>
            )
                ...
                <Container >
                    ...
                    <form onSubmit={this.onSubmit}>
                        ...
                        <div className={classes.paper}>
                            ...
                            <div> <img src={cards}
               alt="card" style={{position: 'flex'}} height="100px" width="800px"/></div>
                                <br/>
                                <Typography variant="h4" color= "Navy" style={{textAlign:'center'}}><strong>AZASE Credit Card</strong></Typography>
                                <br/>
                                <Typography variant="body1"><strong>AZASE Platinum Visa Card: </strong> {this.props.myInfo.accounts[index].account_number}</Typography>
                        ...
                        <div className={classes.paper}>
                            <div style={{float: 'left', width:"100%"}}>
                                <Typography variant="h4" color= "Navy" style={{textAlign:'center'}}><strong>Auto Payment</strong></Typography>
                                <hr/>
                            </div>
                            ...
                            <Paper className="paper" style={detailStyle} >
                                <Typography variant="h6" color= "Navy"><strong>Current Auto Payment List </strong></Typography>
                                <div>
